    ...
    render() {
        return (
            <div className="SkMain">
                ...
                <div className="SkSkillArea">
                    <img src={reactImg} alt="iconPic" className="SkSkillIcon"/>
                    <div className="SkSkillTextBox">
                ...
                <div className="SkSkillArea">
                    <img src={mongodbImg} alt="iconPic" className="SkSkillIcon"/>
                    <div className="SkSkillTextBox">
                ...
                <div className="SkSkillArea">
                    <img src={expressImg} alt="iconPic" className="SkSkillIcon"/>
                    <div className="SkSkillTextBox">
                ...
                <div className="SkSkillArea">
                    <img src={nodeImg} alt="iconPic" className="SkSkillIcon"/>
                    <div className="SkSkillTextBox">
                ...
                <div className="SkSkillArea">
                    <img src={linuxImg} alt="iconPic" className="SkSkillIcon"/>
                    <div className="SkSkillTextBox">
                ...
                <div className="SkSkillArea">
                    <img src={awsImg} alt="iconPic" className="SkSkillIcon"/>
                    <div className="SkSkillTextBox">
                ...
                <div className="SkSkillArea">
                    <img src={agileImg} alt="iconPic" className="SkSkillIcon"/>
                    <div className="SkSkillTextBox">
                ...
                <div className="SkSkillArea">
                    <img src={githubImg} alt="iconPic" className="SkSkillIcon"/>
                    <div className="SkSkillTextBox">
                ...
                <div className="SkSkillArea">
                    <img src={fastifyImg} alt="iconPic" className="SkSkillIcon"/>
                    <div className="SkSkillTextBox">
